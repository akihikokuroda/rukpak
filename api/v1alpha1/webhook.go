...
func (r *Bundle) SetupWebhookWithManager(mgr ctrl.Manager) error {
	bundlelog.Info("SetupWebhookWithManager")
...
func (r *Bundle) ValidateCreate() error {
	bundlelog.Info("validate create", "name", r.Name)
...
func (r *Bundle) ValidateUpdate(old runtime.Object) error {
	bundlelog.Info("validate update", "name", r.Name)
...
func (r *Bundle) ValidateDelete() error {
	bundlelog.Info("validate delete", "name", r.Name)
...
func checkNameLength(r *Bundle) error {
	if len(r.Name) > maxNameLength {
		return fmt.Errorf("bundle name is too long. max length is %d", maxNameLength)
	}
	return nil
}
